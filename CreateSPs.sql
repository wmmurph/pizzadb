...
CREATE PROCEDURE sp_InsertOrder(
    ...
    IN p_tableNum INT,
    IN p_houseNum INT, IN p_street VARCHAR(50), IN p_city VARCHAR(50), IN p_state VARCHAR(2), IN p_zip INT, -- for delivery orders
...
CREATE FUNCTION fn_CalcProfit(p_custPrice DECIMAL(10,2), p_busPrice DECIMAL(10,2))
...
CREATE TRIGGER trg_BeforeInsertPizzaTopping
...
BEGIN
    ...
    SELECT pizza_Size INTO pizzaSize
    FROM pizza
...
IF is_a_percent THEN UPDATE ordertable
